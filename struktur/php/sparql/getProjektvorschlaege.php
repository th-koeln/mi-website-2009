<?php
	...
	if(preg_match("=kord=", $server)){
		$basis = "/home/httpd/vhosts/kord2.de/subdomains/medieninformatik/httpdocs/";
	}else{
		$basis = "/serv/www/$server/data";
	}
	ini_set("include_path", $basis);  
	
	//Funktion holen
	define('MAGPIE_CACHE_ON', 0);	
	require_once 'struktur/php/magpierss-0.72/rss_fetch.inc';
	...
	#Projekte
	$projekte = fetch_rss($url_projekte); ?>
	...
	<div class="mensaplan">
		<table cellpadding=&#039;3&#039; cellspacing=&#039;0&#039;>
			<tbody>
					<?php
					$i = 0;
					foreach ($projekte->items as $item )
					{
						$title = $item[title];
